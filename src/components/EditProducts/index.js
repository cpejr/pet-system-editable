...
export default function AddProducts({ closeModal, product }) {
  ...
  async function handleSubmit() {
    ...
    try {
      const Validate = await api.put(`/api/product/${product.product_id}`, formData, {
        headers: {
      ...
      notification.open({
        message: 'Sucesso!',
        description:
          'A edição do produto foi concluída com sucesso.',
